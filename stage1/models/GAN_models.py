...
class Discriminator_x64_mini(nn.Module):
    """
    Discriminative Network in size 1/4
    """

    def __init__(self, in_size=3, ndf=64):
        super(Discriminator_x64_mini, self).__init__()
        self.in_size = in_size
        self.ndf = ndf
        ...
        #self.last = SpectralNorm(nn.Conv2d(self.ndf * 16, 1, [3, 6], 1, 0))
        self.last_new = SpectralNorm(nn.Conv2d(self.ndf * 4, 1, 3, 1, 0))
